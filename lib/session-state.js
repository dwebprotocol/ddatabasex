module.exports = class SessionState {
  ...
  addBase (id, base, isWeak) {
    ...
    if (!isWeak) this.basestorevault.cache.increment(base.discoveryKey.toString('hex'))
  ...
  deleteBase (id) {
    ...
    if (!isWeak) this.basestorevault.cache.decrement(base.discoveryKey.toString('hex'))
