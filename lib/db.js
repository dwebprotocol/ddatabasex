...
const { NetworkConfiguration } = require('@dhub/rpc/messages')

const INTERNAL_NAMESPACE = '@dhub:internal'
const NETWORK_PREFIX = 'network'

module.exports = class DHubDb extends Nanoresource {
  constructor (basestorevault) {
    super()
  ...
  async _open () {
    this._namespacedStore = this.basestorevault.namespace(INTERNAL_NAMESPACE)
