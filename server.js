...
module.exports = class Hyperspace extends Nanoresource {
  constructor (opts = {}) {
    ...
    startTrieExtension(this.basestorevault)
  ...
  _onConnection (client) {
    const sessionState = new SessionState(this.basestorevault)
    ...
    client.network.onRequest(new NetworkSession(client, sessionState, this.basestorevault, this.networker, this.db, this._networkState, {
